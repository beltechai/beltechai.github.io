  ...
  return (
    <TrafficManagementContainer>
      ...
      <ImpactContentContainer>
        ...
        <ContentContainer2>
          ...
          <GraphContentContainer>
            ...
            <GraphAnalysis1>
              ...
              <AnalysisText>Accuracy</AnalysisText>
            </GraphAnalysis1>
            <GraphAnalysisContainer>
              <GraphAnalysis>
        ...
        <ContentContainer>
          <TextContentHeading>Reduction in Toxic Emissions</TextContentHeading>
          <GraphContentContainer>
            <BackGroundCircle3 />
            <Image src={Graph3} />
            <GraphAnalysis>
              ...
              <DownArrow>&darr; </DownArrow>
              <AnalysisText>Reduction in toxic emission per day</AnalysisText>
            </GraphAnalysis>
          </GraphContentContainer>
          <TextContentContainer>
            <TextContentSubHeading>
          ...
          <TextContentContainer>
            <TextContentSubHeading>
              <BulletPointContainer>
                <BulletPoint />
                <BulletPointText>
                  Live location of vehicles with unpaid traffic violations near
                  the authprities
                </BulletPointText>
              </BulletPointContainer>
              <BulletPointContainer>
